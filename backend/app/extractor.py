"""
extractor.py
F1: RFP Analyzer — text extraction layer.

Pulls clean, structured text out of uploaded RFP/RFQ/Tender documents
(PDF or DOCX). Keeps lightweight page markers so downstream prompts
can reference "where" a requirement was found.
"""
...
class EmptyDocumentError(Exception):
    """Raised when extraction yields no usable text (e.g. scanned image PDF)."""
